...
public class ProfileTest {
    ...
    @Rule
    public final IntentsTestRule<FragmentProfile> testRule = new IntentsTestRule<>(FragmentProfile.class);
    ...
    public void shouldAvatarHasDefaultOneInitially() {
        User user = Database.getInstance().getDefaultAvatar();
        onView(withId(R.id.imgAvatar)).check(
                matches(withTagValue(equalTo(user.getImageResId()))));
        onView(withId(R.id.lblAvatar)).check(matches(withText(user.getName())));
    }
